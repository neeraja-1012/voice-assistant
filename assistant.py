...
def run_CHITTI():
    ...
    elif "who is neeru" in command or "who is neeru" in command:
        info = (
            "neeru is the owner of this laptop . "
            "she gives command to me"
        )
        talk(info)
...
talk("hey! I'm CHITTI – your personal voice assistant ")
while True:
    run_CHITTI()
